...
\bibitem{carmonaVaro} \textbf{Carmona Varo, F., y Cerruela García, G.} (2009).\\
...
\bibitem{subversion} \textbf{Subversion} (2009).\\
         ...
         [Consulta: 20 junio 2009].
\bibitem{wikipedia1} \textbf{Wikipedia - Decorador} (2009).\\
         Sitio oficial del proyecto.\\
         url: \url{http://en.wikipedia.org/wiki/Python_syntax_and_semantics}
         [Consulta: 24 diciembre 2010].
\bibitem{wikipedia2} \textbf{Wikipedia - Framework} (2009).\\
         Sitio oficial del proyecto.\\
