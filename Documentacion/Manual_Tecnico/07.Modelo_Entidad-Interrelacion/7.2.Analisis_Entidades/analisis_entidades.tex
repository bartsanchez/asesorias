\section{Análisis de entidades}
   ...
   \begin{itemize}
    ...
    \item Entidad Matrícula.
    \item Entidad Calificación Convocatoria.
   ...
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/eCentro}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/eAdministradorCentro}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/eTitulacion}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/eAsignatura}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/eACA}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/eDepartamento}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/eAsesor}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/eAsesorCA}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/ePlantEntAse}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/ePregAse}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/eAlumno}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/eAlumnoCA}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/eMatricula}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/eCalConv}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/ePlantEntOfi}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/ePregOfi}
   \input{07.Modelo_Entidad-Interrelacion/7.2.Analisis_Entidades/eReunion}
