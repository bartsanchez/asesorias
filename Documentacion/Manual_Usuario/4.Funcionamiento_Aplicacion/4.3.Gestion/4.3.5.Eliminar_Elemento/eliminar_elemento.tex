\section{Eliminar elemento}
  ...
  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.5.Eliminar_Elemento/delElemento.png}
      }
  ...
  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.5.Eliminar_Elemento/pantalla_confirmacion.png}
      }
