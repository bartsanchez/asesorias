\subsubsection{Añadir}
  ...
  \ref{capturaAddCentroAdministradorCentro}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.4.Centro_AdministradorCentro/add_centro_adminCentro.png}
      }
      \caption{Captura de pantalla del formulario de creación de \textit{Centro - Administrador de centro}.}
      \label{capturaAddCentroAdministradorCentro}
    \end{center}
  \end{figure}
