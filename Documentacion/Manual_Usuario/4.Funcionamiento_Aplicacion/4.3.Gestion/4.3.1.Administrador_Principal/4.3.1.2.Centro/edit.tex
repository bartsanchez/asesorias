\subsubsection{Editar}
  ...
  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.1.Introduccion/editElemento.png}
      }
  ...
  \ref{capturaEditCentro}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.2.Centro/edit_centro.png}
      }
      \caption{Captura de pantalla del formulario de edición de \textit{Centro}.}
      \label{capturaEditCentro}
    \end{center}
  \end{figure}
