\subsubsection{Añadir}
  ...
  \ref{capturaAddPreguntaOficial}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.19.PreguntaOficial/add_pregunta_oficial.png}
      }
      \caption{Captura de pantalla del formulario para la creación de \textit{Pregunta oficial}.}
      \label{capturaAddPreguntaOficial}
    \end{center}
  \end{figure}
