\subsubsection{Añadir}\label{addAsignatura}
  ...
  \ref{capturaAddAsignatura}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.6.Asignatura/add_asignatura.png}
      }
