\subsubsection{Editar}
  ...
  \ref{capturaEditAsignatura}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.6.Asignatura/edit_asignatura.png}
      }
      \caption{Captura de pantalla del formulario de edición de \textit{Asignatura}.}
      \label{capturaEditAsignatura}
    \end{center}
  \end{figure}
