\subsubsection{Editar}
  ...
  \ref{capturaEditMatricula}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.13.Matricula/edit_matricula.png}
      }
      \caption{Captura de pantalla del formulario de edición para \textit{Matrícula}.}
      \label{capturaEditMatricula}
    \end{center}
  \end{figure}
