\subsubsection{Añadir}
  ...
  \ref{capturaAddCalificacion}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.14.CalificacionConvocatoria/add_calificacion.png}
      }
      \caption{Captura de pantalla del formulario de creación de \textit{Calificación convocatoria}.}
      \label{capturaAddCalificacion}
    \end{center}
  \end{figure}
