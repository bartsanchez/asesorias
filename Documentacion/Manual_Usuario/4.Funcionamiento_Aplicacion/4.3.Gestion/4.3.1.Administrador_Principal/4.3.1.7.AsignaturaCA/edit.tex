\subsubsection{Editar}
  ...
  \ref{capturaEditAsignaturaCA}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.7.AsignaturaCA/edit_asignaturaCA.png}
      }
      \caption{Captura de pantalla del formulario de edición para \textit{Asignatura curso académico}.}
      \label{capturaEditAsignaturaCA}
    \end{center}
  \end{figure}
