\subsubsection{Editar}
  ...
  \ref{capturaEditAlumno}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.11.Alumno/edit_alumno.png}
      }
      \caption{Captura de pantalla del formulario de edición de \textit{Alumno}.}
      \label{capturaEditAlumno}
    \end{center}
  \end{figure}
