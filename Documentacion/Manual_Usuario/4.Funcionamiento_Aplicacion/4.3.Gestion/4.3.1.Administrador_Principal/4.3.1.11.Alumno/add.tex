\subsubsection{Añadir}\label{addAlumno}
  ...
  \ref{capturaAddAlumno}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.11.Alumno/add_alumno.png}
      }
      \caption{Captura de pantalla del formulario de creación de \textit{Alumno}.}
      \label{capturaAddAlumno}
    \end{center}
  \end{figure}
