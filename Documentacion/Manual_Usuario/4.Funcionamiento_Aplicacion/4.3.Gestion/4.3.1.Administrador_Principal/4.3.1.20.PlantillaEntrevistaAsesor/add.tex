\subsubsection{Añadir}\label{addPlantillaAsesor}
  ...
  \ref{capturaAddPlantillaAsesor}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.20.PlantillaEntrevistaAsesor/add_plantilla_asesor.png}
      }
      \caption{Captura de pantalla del formulario para la creación de \textit{Plantilla de entrevista de asesor}.}
      \label{capturaAddPlantillaAsesor}
    \end{center}
  \end{figure}
