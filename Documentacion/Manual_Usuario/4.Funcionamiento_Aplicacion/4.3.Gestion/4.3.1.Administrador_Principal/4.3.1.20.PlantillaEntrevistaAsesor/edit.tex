\subsubsection{Editar}
  ...
  \ref{capturaEditPlantillaAsesor}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.20.PlantillaEntrevistaAsesor/edit_plantilla_asesor.png}
      }
      \caption{Captura de pantalla del formulario de edición de \textit{Plantilla de entrevista de asesor}.}
      \label{capturaEditPlantillaAsesor}
    \end{center}
  \end{figure}
