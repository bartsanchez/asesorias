\subsubsection{Añadir}\label{addDepartamento}
  ...
  \ref{capturaAddDepartamento}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.8.Departamento/add_departamento.png}
      }
      \caption{Captura de pantalla del formulario de creación de \textit{Departamento}.}
      \label{capturaAddDepartamento}
    \end{center}
  \end{figure}
