\subsubsection{Editar}
  ...
  \ref{capturaEditAsesor}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.9.Asesor/edit_asesor.png}
      }
      \caption{Captura de pantalla del formulario de edición de \textit{Asesor}.}
      \label{capturaEditAsesor}
    \end{center}
  \end{figure}
