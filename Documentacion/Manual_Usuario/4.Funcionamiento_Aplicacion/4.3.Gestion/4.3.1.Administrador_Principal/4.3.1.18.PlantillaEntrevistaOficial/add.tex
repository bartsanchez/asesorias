\subsubsection{Añadir}
  ...
  \ref{capturaAddPlantillaOficial}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.18.PlantillaEntrevistaOficial/add_plantilla_oficial.png}
      }
      \caption{Captura de pantalla del formulario de creación de \textit{Plantilla de entrevista oficial}.}
      \label{capturaAddPlantillaOficial}
    \end{center}
  \end{figure}
