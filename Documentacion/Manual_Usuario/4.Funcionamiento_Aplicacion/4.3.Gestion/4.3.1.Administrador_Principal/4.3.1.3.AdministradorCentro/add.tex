\subsubsection{Añadir}
  ...
  \ref{capturaAddAdministradorCentro}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.3.AdministradorCentro/add_admin_centro.png}
      }
      \caption{Captura de pantalla del formulario de creación de \textit{Administrador de centro}.}
      \label{capturaAddAdministradorCentro}
    \end{center}
  \end{figure}
