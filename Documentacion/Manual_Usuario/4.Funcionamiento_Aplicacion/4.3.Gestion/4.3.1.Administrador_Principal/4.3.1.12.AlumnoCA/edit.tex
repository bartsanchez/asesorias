\subsubsection{Editar}
  ...
  \ref{capturaEditAlumnoCA}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.12.AlumnoCA/edit_alumnoCA.png}
      }
      \caption{Captura de pantalla del formulario de edición de \textit{Alumno curso académico}.}
      \label{capturaEditAlumnoCA}
    \end{center}
  \end{figure}
