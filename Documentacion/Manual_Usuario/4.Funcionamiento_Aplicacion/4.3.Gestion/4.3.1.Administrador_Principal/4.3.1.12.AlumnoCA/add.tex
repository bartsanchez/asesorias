\subsubsection{Añadir}\label{addAlumnoCA}
  ...
  \ref{capturaAddAlumnoCA}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.12.AlumnoCA/add_alumnoCA.png}
      }
      \caption{Captura de pantalla del formulario para la creación de \textit{Alumno curso académico}.}
      \label{capturaAddAlumnoCA}
    \end{center}
  \end{figure}
