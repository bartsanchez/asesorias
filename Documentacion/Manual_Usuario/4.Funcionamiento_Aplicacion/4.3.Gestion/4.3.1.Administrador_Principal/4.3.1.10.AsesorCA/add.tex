\subsubsection{Añadir}\label{addAsesorCA}
  ...
  \ref{capturaAddAsesorCA}.

  \begin{figure}[!ht]
    \begin{center}
      \fbox{
      \includegraphics[scale=0.55]{4.Funcionamiento_Aplicacion/4.3.Gestion/4.3.1.Administrador_Principal/4.3.1.10.AsesorCA/add_asesorCA.png}
      }
      \caption{Captura de pantalla del formulario de creación de \textit{Asesor curso académico}.}
      \label{capturaAddAsesorCA}
    \end{center}
  \end{figure}
