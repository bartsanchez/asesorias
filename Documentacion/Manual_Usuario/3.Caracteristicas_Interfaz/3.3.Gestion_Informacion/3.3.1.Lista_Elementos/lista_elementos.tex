\subsection{Lista de elementos}
  ...
  \begin{itemize}
   ...
   \begin{figure}[!ht]
    \begin{center}
      \fbox{
        \includegraphics[scale=0.6]{3.Caracteristicas_Interfaz/3.3.Gestion_Informacion/3.3.1.Lista_Elementos/busqueda_elementos.png}
      }
  ...
  \begin{figure}[!ht]
    \begin{center}
      \fbox{
        \includegraphics[scale=0.6]{3.Caracteristicas_Interfaz/3.3.Gestion_Informacion/3.3.1.Lista_Elementos/lista_elementos.png}
      }
