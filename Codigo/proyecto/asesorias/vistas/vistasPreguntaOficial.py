...
from asesorias.vistas import vistasPlantillaEntrevistaOficial
...
def editPreguntaOficial(request, id_entrevista_oficial, id_pregunta_oficial):
	...
	if instancia_pregunta_oficial:
		...
		form = forms.PreguntaOficialForm(instance=instancia_pregunta_oficial, initial={'plantilla_entrevista_oficial': vistasPlantillaEntrevistaOficial.obtenerPlantillaEntrevistaOficial(id_entrevista_oficial).id_entrevista_oficial})
	...
	# La pregunta oficial no existe.
		...
		form = False
	return render_to_response('asesorias/PreguntaOficial/editPreguntaOficial.html', {'form': form})
