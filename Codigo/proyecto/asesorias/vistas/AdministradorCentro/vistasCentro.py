...
PATH = 'asesorias/UsuarioAdministradorCentro/Centro/'
...
def editCentro(request, centro):
    ...
    # El centro no existe.
        ...
        form = False
    return render_to_response(PATH + 'editCentro.html',
        {'user': request.user, 'form': form})
...
def delCentro(request, centro):
    ...
    # El centro no existe.
        ...
        error = True
    return render_to_response(PATH + 'delCentro.html',
...
def listCentro(request, orden):
    ...
    return render_to_response(PATH + 'listCentro.html',
        {'user': request.user, 'form': form,
...
def generarPDFListaCentros(request, busqueda):
    ...
    return vistasPDF.render_to_pdf(PATH + 'plantilla_pdf.html',
