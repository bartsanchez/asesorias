...
urlpatterns += patterns('',
	...
	url(r'^asesorias/asesorCursoAcademico/departamento/(?P<nombre_departamento>[\s\w]+)/list/$', 'proyecto.asesorias.vistas.vistasAsesorCursoAcademico.listAsesorCursoAcademico_Departamento', name='listAsesorCursoAcademico_Departamento'),
