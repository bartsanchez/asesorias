...
urlpatterns += patterns('',
	...
	url(r'^asesorias/centro/generarPDF/(?P<busqueda>[\s\w]+)/$', 'proyecto.asesorias.vistas.vistasCentro.generarPDFListaCentros', name='generarPDFListaCentros'),
)
...
urlpatterns += patterns('',
	...
	url(r'^asesorias/administradorCentro/list/(?P<orden>[\s\w]*)/$', 'proyecto.asesorias.vistas.vistasAdministradorCentro.listAdministradorCentro', name='listAdministradorCentro'),
...
urlpatterns += patterns('',
	...
	url(r'^asesorias/asignatura/list/(?P<nombre_centro>[\s\w]+)/(?P<nombre_titulacion>[\s\w]+)/(?P<plan_estudios>\d+)/(?P<orden>[\s\w]*)/$', 'proyecto.asesorias.vistas.vistasAsignatura.listAsignatura', name='listAsignatura'),
	url(r'^asesorias/asignatura/selectCentro/$', 'proyecto.asesorias.vistas.vistasAsignatura.selectCentro', name='selectCentro_Asignatura'),
	url(r'^asesorias/asignatura/(?P<nombre_centro>[\s\w]+)/selectTitulacion/$', 'proyecto.asesorias.vistas.vistasAsignatura.selectTitulacion', name='selectTitulacion_Asignatura'),
...
urlpatterns += patterns('',
	...
	url(r'^asesorias/departamento/list/(?P<orden>[\s\w]*)/$', 'proyecto.asesorias.vistas.vistasDepartamento.listDepartamento', name='listDepartamento'),
	url(r'^asesorias/departamento/generarPDF/$', 'proyecto.asesorias.vistas.vistasDepartamento.generarPDFListaDepartamentos', name='generarPDFListaDepartamentos'),
)
...
urlpatterns += patterns('',
	...
	url(r'^asesorias/asesor/list/(?P<orden>[\s\w]*)/$', 'proyecto.asesorias.vistas.vistasAsesor.listAsesor', name='listAsesor'),
	url(r'^asesorias/asesor/generarPDF/$', 'proyecto.asesorias.vistas.vistasAsesor.generarPDFListaAsesores', name='generarPDFListaAsesores'),
)
...
urlpatterns += patterns('',
	...
	url(r'^asesorias/asesorCursoAcademico/departamento/(?P<nombre_departamento>[\s\w]+)/(?P<dni_pasaporte>[\s\w]+)/(?P<orden>[\s\w]*)/list/$', 'proyecto.asesorias.vistas.vistasAsesorCursoAcademico.listAsesorCursoAcademico_Departamento', name='listAsesorCursoAcademico_Departamento'),
	url(r'^asesorias/asesorCursoAcademico/list/asesor/(?P<dni_pasaporte>[\s\w]+)/(?P<orden>[\s\w]*)/$', 'proyecto.asesorias.vistas.vistasAsesorCursoAcademico.listAsesorCursoAcademico_Asesor', name='listAsesorCursoAcademico_Asesor'),
	...
	url(r'^asesorias/asesorCursoAcademico/(?P<nombre_departamento>[\s\w]+)/selectAsesor/$', 'proyecto.asesorias.vistas.vistasAsesorCursoAcademico.selectAsesorDepartamento', name='selectAsesorDepartamento_AsesorCursoAcademico'),
	...
	url(r'^asesorias/asesorCursoAcademico/generarPDF/$', 'proyecto.asesorias.vistas.vistasAsesorCursoAcademico.generarPDFListaAsesoresCursoAcademico', name='generarPDFListaAsesoresCursoAcademico'),
)
...
urlpatterns += patterns('',
	...
	url(r'^asesorias/alumno/list/(?P<orden>[\s\w]*)/$', 'proyecto.asesorias.vistas.vistasAlumno.listAlumno', name='listAlumno'),
	url(r'^asesorias/alumno/generarPDF/$', 'proyecto.asesorias.vistas.vistasAlumno.generarPDFListaAlumnos', name='generarPDFListaAlumnos'),
)
...
urlpatterns += patterns('',
	...
	url(r'^asesorias/alumnoCursoAcademico/list/(?P<dni_pasaporte>[\s\w]+)/(?P<orden>[\s\w]*)/$', 'proyecto.asesorias.vistas.vistasAlumnoCursoAcademico.listAlumnoCursoAcademico', name='listAlumnoCursoAcademico'),
	url(r'^asesorias/alumnoCursoAcademico/selectAlumno/$', 'proyecto.asesorias.vistas.vistasAlumnoCursoAcademico.selectAlumno', name='selectAlumno_AlumnoCursoAcademico'),
	url(r'^asesorias/alumnoCursoAcademico/generarPDF/$', 'proyecto.asesorias.vistas.vistasAlumnoCursoAcademico.generarPDFListaAlumnosCursoAcademico', name='generarPDFListaAlumnosCursoAcademico'),
)
...
urlpatterns += patterns('',
	...
	url(r'^asesorias/matricula/list/(?P<nombre_centro>[\s\w]+)/(?P<nombre_titulacion>[\s\w]+)/(?P<plan_estudios>\d+)/(?P<nombre_asignatura>[\s\w]+)/(?P<curso_academico>\d+)/(?P<orden>[\s\w]*)/$', 'proyecto.asesorias.vistas.vistasMatricula.listMatricula', name='listMatricula'),
	url(r'^asesorias/matricula/select/$', 'proyecto.asesorias.vistas.vistasMatricula.selectAsignaturaCursoAcademicoOAlumnoCursoAcademico', name='selectAsignaturaCursoAcademicoOAlumnoCursoAcademico'),
...
urlpatterns += patterns('',
	...
	url(r'^asesorias/centro_administradorCentro/list/(?P<centro>[\s\w]+)/(?P<orden>[\s\w]*)/$', 'proyecto.asesorias.vistas.vistasCentro_administradorCentro.listCentro_administradorCentro', name='listCentro_administradorCentro'),
	url(r'^asesorias/centro_administradorCentro/select/$', 'proyecto.asesorias.vistas.vistasCentro_administradorCentro.selectCentro', name='selectCentro_CentroAdministradorCentro'),
