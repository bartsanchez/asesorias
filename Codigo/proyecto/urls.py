...
urlpatterns += patterns('',
	...
	url(r'^asesorias/titulacion/generarPDF/$', 'asesorias.vistas.vistasTitulacion.generarPDFListaTitulaciones', name='generarPDFListaTitulaciones'),
)
...
urlpatterns += patterns('',
	...
	url(r'^asesorias/asignatura/generarPDF/$', 'asesorias.vistas.vistasAsignatura.generarPDFListaAsignaturas', name='generarPDFListaAsignaturas'),
)
...
urlpatterns += patterns('',
	...
	url(r'^asesorias/asesorCursoAcademico/departamento/(?P<nombre_departamento>[\s\w]+)/(?P<dni_pasaporte>[\s\w]+)/(?P<orden>[\s\w]*)/list/$', 'asesorias.vistas.vistasAsesorCursoAcademico.listAsesorCursoAcademico_Departamento', name='listAsesorCursoAcademico_Departamento'),
	url(r'^asesorias/asesorCursoAcademico/list/asesor/(?P<dni_pasaporte>[\s\w]+)/(?P<orden>[\s\w]*)/$', 'asesorias.vistas.vistasAsesorCursoAcademico.listAsesorCursoAcademico_Asesor', name='listAsesorCursoAcademico_Asesor'),
	url(r'^asesorias/asesorCursoAcademico/selectDepartamentoOAsesor/$', 'asesorias.vistas.vistasAsesorCursoAcademico.selectDepartamentoOAsesor', name='selectDepartamentoOAsesor_AsesorCursoAcademico'),
	...
	url(r'^asesorias/asesorCursoAcademico/(?P<nombre_departamento>[\s\w]+)/selectAsesor/$', 'asesorias.vistas.vistasAsesorCursoAcademico.selectAsesorDepartamento', name='selectAsesorDepartamento_AsesorCursoAcademico'),
	...
	url(r'^asesorias/asesorCursoAcademico/generarPDF/$', 'asesorias.vistas.vistasAsesorCursoAcademico.generarPDFListaAsesoresCursoAcademico', name='generarPDFListaAsesoresCursoAcademico'),
)
